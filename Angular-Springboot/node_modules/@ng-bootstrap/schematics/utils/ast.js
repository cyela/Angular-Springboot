 ...
 */
function addModuleImportToRootModule(host, moduleName, importSrc) {
    // TODO(pk): path here is hard-coded
    addModuleImportToModule(host, core_1.normalize(`src/app/app.module.ts`), moduleName, importSrc);
}
